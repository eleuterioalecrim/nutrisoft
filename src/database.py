...
from .config import DATA_DIR, REPORTS_DIR, CHARTS_DIR, PDF_DIR, CSV_FILES
...
"historico_edicoes": [
    "historico_id", "data_hora", "base", "registro_id", "campo",
    "valor_anterior", "valor_novo", "usuario", "motivo"
],
}
